package com.example.screen_adaptation.config;

import android.content.Context;
import android.content.pm.ApplicationInfo;
import android.content.pm.PackageManager;

import com.example.screen_adaptation.utils.L;
import com.example.screen_adaptation.utils.ScreenUtils;
...
public class AutoLayoutConifg {
    ...
    public void init(Context context) {
        ...
        float wPercent = (float) mScreenWidth / (float) mDesignWidth;
        float hPercent = (float) mScreenHeight / (float) mDesignHeight;
        L.e("      AutoLayoutConfig:" + "  wPercent:" + wPercent + "   hPercent:" + hPercent);
    }
